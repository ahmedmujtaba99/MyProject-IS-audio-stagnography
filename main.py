...
#         encode_button = ttk.Button(self, text="Encode", command=self.encode, style="TButton")
#         encode_button.pack(pady=5)
#         encode_button.bind("<Enter>", lambda event: encode_button.configure(style="TButtonHover"))
#         encode_button.bind("<Leave>", lambda event: encode_button.configure(style="TButton"))

#         decode_button = ttk.Button(self, text="Decode", command=self.decode, style="TButton")
#         decode_button.pack(pady=5)
#         decode_button.bind("<Enter>", lambda event: decode_button.configure(style="TButtonHover"))
#         decode_button.bind("<Leave>", lambda event: decode_button.configure(style="TButton"))
...
#         self.style.configure("TButton", foreground="white", background="blue", padding=(5, 5))
#         self.style.map("TButton", background=[("active", "green")])

#         self.style.configure("TButtonHover", foreground="white", background="green", padding=(5, 5))
